    ...
    <template #body>
      <div class="header flex align-center justify-between p-[20px]">
        <div class="text-center mb-4">
          <h1 class="text-[24px] text-[#015812]">
      ...
      <div class="flex justify-center">
        <div class="w-[634px] bg-white p-6 rounded-lg w-96 max-630:w-full">
          ...
          <div class="flex flex-col items-end mb-[17px] mt-4">
            ...
            <span class="text-center mr-[15px]"
              >{{ $util.currency(order?.total_price) }}
              {{ order?.Currency?.symbol }}</span
            >
          </div>
          <div class="flex justify-between text-sm font-medium mb-2">
            <span>Xizmat ko'rsatish haqqi: {{ order?.service_fee }} %</span>
            <span
      ...
      <div
        class="flex justify-end h-[38%] items-end mr-[15px] max-1600:h-[20%]"
      >
        <button>
